...
Garantit le transport de bout en bout entre applications. Segmentation/réassemblage, fiabilité optionnelle, contrôle de flux, contrôle de congestion, multiplexage. Protocoles typiques : TCP, UDP.
...
- Rose : Réseau
- Trouvé : Transport
- SPA : Session, Présentation, Application
